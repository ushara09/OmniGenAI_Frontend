        ...
        <nav id="sidebar-nav">
            ...
            <div id="menu">
                <ul class="list-unstyled components">
                    <li class="active">
                        <a  href="#"><span className="p-left" >Company Management</span></a>
                    </li>
                    <li>
                        <a href="#pageSubmenu1" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle submenu"><span className="p-left" >AI Management</span></a>
